#+STUPFILE: https://fniessen.github.io/org-html-themes/setup/theme-readtheorg.setup
...
** Обозначения
  ...
  -!- - Сиволы в заголовке обозначающие тключенный пакет.
...
* Настройка Emacs для программирования
** org-mode
...
** golang
*** Настройки в операционной системе OSX

  #+BEGIN_VERSE
  *Командная строка: ~/.zshrc
  export GOPATH=~/Drive/dev/go:~/go
  export GOROOT=/usr/local/opt/go/libexec
  export PATH=$PATH:$GOPATH/bin
  export PATH=$PATH:$GOROOT/bin
  go get golang.org/x/tools/gopls@latest
  #+END_VERSE
*** TODO Настройки в операционной системе Windows
*** TODO Настройки в операционной системе Linux
** lsp-mode

  Клиент для серверов поддержки синтаксисов языков.
...
** TODO установка языковых серверов
