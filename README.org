...
** ЗАДАЧА: Сочетания клавиш                             :@разработка:сделать:
	 ...
	 Пользовательские  сочетания клавишь，которые были забиндены для удобного использования пакетов：
	 
** Установка                                            :@разработка:сделать:
...
+ Скачать и установить [[https://emacsformacosx.com][Emacs]]. 
  Примечание: Версия из homebrew emacs-plus не запускается из spotlight，поэтому вместо ссылки на исполняемый файл копируем его．
